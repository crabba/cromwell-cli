...
task P2Prep {
    ...
    Int diskGb_p2prep = ceil(3.0 * size(inputFile, "G"))
    
    runtime {
        docker : "szarate/p2_prep:v0.0.1"
        disks : "local-disk ${diskGb_p2prep} SSD"
    }
...
task SplitByChrom {
    ...
    Int diskGb_splitbychrom = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "mgibio/sambamba-cwl:0.6.4"
        disks : "local-disk ${diskGb_splitbychrom} SSD"
    }
...
task PrepareBreakdancer {
    ...
    Int diskGb_preparebreakdancer = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/breakdancer:v1.4.3"
        disks : "local-disk ${diskGb_preparebreakdancer} SSD"
    }
...
task BreakdancerChrom {
    ...
    Int diskGb_breakdancerchrom = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/breakdancer:v1.4.3"
        disks : "local-disk ${diskGb_breakdancerchrom} SSD"
    }
...
task Breakseq {
    ...
    Int diskGb_breakseq = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/breakseq2:v2.2"
        disks : "local-disk ${diskGb_breakseq} SSD"
        cpu : 8
    }
...
task CNVnatorChrom {
    ...
    Int diskGb_cnvnatorchrom = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/cnvnator:v0.4.1"
        disks : "local-disk ${diskGb_cnvnatorchrom} SSD"
        cpu : 8
    }
...
task Manta {
    ...
    Int diskGb_manta = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/manta:v1.6.0"
        disks : "local-disk ${diskGb_manta} SSD"
        cpu : 8
    }
...
task SVTyper {
    ...
    Int diskGb_svtyper = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/svtyper:v0.7.0"
        disks : "local-disk ${diskGb_svtyper} SSD"
    }
...
task svvizChrom {
    ...
    Int diskGb_svvizchrom = ceil(2.0 * size(inputBam, "G"))

    runtime {
        docker : "szarate/svviz:v1.6.2"
        disks : "local-disk ${diskGb_svvizchrom} SSD"
        cpu : 8
    }
